                ...
                <div className="relative p-4 bg-white rounded-lg shadow sm:p-5">
                    ...
                    <form onSubmit={handleSubmit} aria-labelledby="modal-title">
                        ...
                        <div className="flex items-center space-x-4">
                            <button type="submit" className="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Actualizar curso</button>
                        </div>
                    </form>
                </div>
            </div>
