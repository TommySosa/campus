        ...
        <>
                ...
                <tbody>
                    {
                            ...
                            <tr className="border-b border-gray-700" key={content.id_content}>
                                ...
                                <td className="px-4 py-3 flex items-center justify-end">
                                    <button
                                        ...
                                        onClick={() => handleOpenUpdate(content.id_content)}
                                    >
                                    ...
                                    <button
                                        ...
                                        onClick={() => handleOpenDelete(content.id_content)}
                                    >
                        ...
                        )) : noFiltrados.length > 0 ? noFiltrados.map((content) => (
                            <>
                                <tr className="border-b border-gray-700" key={content.id_content}>
                                    <th scope="row" className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">{content.title}</th>
                                    <td className="px-4 py-3 max-w-[12rem] truncate">{content.description}</td>
                        ...
                        )) : <p className="text-center">No se pudo obtener los contenidos</p>
                    }
                        ...
                        selectedUpdateCourseId !== null && (
                            <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50">
                                <UpdateModal
                                    ...
                                    id_content={selectedUpdateCourseId}
            ...
            <nav className="flex flex-col md:flex-row justify-between items-start md:items-center py-8 space-y-3 md:space-y-0 p-4" aria-label="Table navigation">
                <span className="text-sm font-normal text-gray-500 dark:text-gray-400">
                    Mostrando
                    <span className="font-semibold text-gray-900  "> {contents.length > 0 ? contents.length : noFiltrados.length} </span>
                    de
                    <span className="font-semibold text-gray-900  "> {noFiltrados ? noFiltrados.length : contents.length} </span>
                </span>
