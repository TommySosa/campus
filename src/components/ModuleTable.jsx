"use client"
import UpdateModal from "./UpdateModuleModal"
import CreateModal from "./CreateModuleModal"
import DeleteModal from "./DeleteModuleModal"
import { useState } from "react"
export default function ModuleTable({exercises, openCreate, handleOpenCreate, handleRefresh}) {
                    ...
                    selectedUpdateCourseId !== null && (
                        <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50">
                            <UpdateModal
                                ...
                                id_exercise={selectedUpdateCourseId}
                            />
                        </div>
                    )
                }
                    ...
                    selectedDeleteCourseId !== null && (
                        <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50">
                            <DeleteModal
                                ...
                                id_exercise={selectedDeleteCourseId}
