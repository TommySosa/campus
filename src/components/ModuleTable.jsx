...
export default function ModuleTable({ modules, openCreate, handleOpenCreate, handleRefresh }) {
        ...
        <>
                ...
                <tbody>
                    {
                                ...
                                <tr className="border-b border-gray-700" key={module.id_module}>
                                    ...
                                    <td className="px-4 py-3 flex items-center justify-end">
                                        <button
                                            ...
                                            onClick={() => handleOpenUpdate(module.id_module)}
                                        >
                                        ...
                                        <button
                                            ...
                                            onClick={() => handleOpenDelete(module.id_module)}
                                        >
                        ...
                        )) : noFiltrados.length > 0 ? noFiltrados.map((module) => (
                            <>
                                <tr className="border-b border-gray-700" key={module.id_module}>
                                    <th scope="row" className="px-8 py-3 font-medium text-gray-900 whitespace-nowrap ">{module.name}</th>
                                    <td className="px-8 py-3">{module.course_name}</td>
                        ...
                        )) : <p className="text-center my-4">Error al obtener los módulos</p>
                    }
                        ...
                        selectedUpdateCourseId !== null && (
                            <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50">
                                <UpdateModal
                                    ...
                                    id_module={selectedUpdateCourseId}
                        ...
                        selectedDeleteCourseId !== null && (
                            <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50">
                                <DeleteModal
                                    ...
                                    id_module={selectedDeleteCourseId}
                                    handleRefresh={handleRefresh}
                                />
                            </div>
                        )
            ...
            <nav className="flex flex-col md:flex-row justify-between items-start md:items-center py-8  space-y-3 md:space-y-0 p-4" aria-label="Table navigation">
                <span className="text-sm font-normal text-gray-500 dark:text-gray-400">
                    Mostrando
                    <span className="font-semibold text-gray-900  "> {modules.length > 0 ? modules.length : noFiltrados.length} </span>
                    de
                    <span className="font-semibold text-gray-900  "> {noFiltrados ? noFiltrados.length : modules.length} </span>
                </span>
