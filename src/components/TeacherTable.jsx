            ...
            <tbody>
                {
                    teachers.length > 0 ? teachers.map((teacher) => (
                        <>
                        <tr className="border-b border-gray-700" key={teacher.id_user}>
                            <th scope="row" className="px-8 py-3 font-medium text-gray-900 whitespace-nowrap ">{teacher.name + " " + teacher.surname}</th>
                            <td className="px-8 py-3">{teacher.dni}</td>
                            <td className="px-8 py-3">{teacher.id_rol === 2 ? "PROFESOR" : "ESTUDIANTE"}</td>
                            <td className="px-4 py-3 flex items-center justify-end">
                                <button
                                    ...
                                    onClick={() => handleOpenUpdate(teacher.id_user)}
                                >
                                ...
                                <button
                                    ...
                                    onClick={() => handleOpenDelete(teacher.id_user)}
                                >
                    ...
                    )) : noFiltrados && noFiltrados.length > 0 ? noFiltrados.map((teacher) => (
                         <>
                        <tr className="border-b border-gray-700" key={teacher.id_user}>
                            <th scope="row" className="px-8 py-3 font-medium text-gray-900 whitespace-nowrap ">{teacher.name + " " + teacher.surname}</th>
                            <td className="px-8 py-3">{teacher.dni}</td>
                    ...
                    selectedUpdateCourseId !== null && (
                        <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50">
                            <UpdateModal
                                ...
                                id_user={selectedUpdateCourseId}
                    ...
                    selectedDeleteCourseId !== null && (
                        <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50">
                            <DeleteModal
                                ...
                                id_user={selectedDeleteCourseId}
                                handleRefresh={handleRefresh}
                            />
                        </div>
                    )
