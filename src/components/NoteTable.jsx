...
export default function ModuleTable({ notes, openCreate, handleOpenCreate, handleRefresh }) {
    ...
    return (
        <>
            <table className="w-full text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    {
                        notes.length > 0 ? notes.map((module) => (
                            <>
                        ...
                        )) : <p className="text-center my-4">Error al obtener las notas</p>
                    }
