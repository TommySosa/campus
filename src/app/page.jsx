    ...
    <main className='flex items-center justify-center ' style={{ height: '80vh' }}>
      <form onSubmit={handleSubmit} className="form_main before:bg-elf-green-300">
        ...
        <div className="inputContainer">
          ...
          <input type="text" className="inputField" id="email" placeholder="Email" name="email" onChange={(e) =>
            setCredentials({
              ...credentials,
        ...
        <div className="inputContainer">
          ...
          <input type="password" className="inputField" id="password" placeholder="Password" name="password" onChange={(e) =>
            setCredentials({
              ...credentials,
